...
const NavBar = () => {
  ...
  return (
  <div className="flex justify-between items-center w-full px-4 text-white bg-black fixed mb-150px ">
    <div>
        <h1 className="text-4xl font-signature ml-2">Shreya Konduskar</h1>
    </div>
